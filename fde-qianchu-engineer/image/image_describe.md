...
| `10-echo-delta.jpg` | 第一节中段（Sankar 段后） | Palantir 总部 → 客户现场嵌入工程师 + 分析师双人组的概念图 | 把 Palantir Echo-Delta 起源模式视觉化，让读者一图理解 FDE 原型 |
| `11-china-vs-sv.jpg` | 第七节中段（对比段后） | 左右对比图：硅谷客户 4 周 vs 中国客户 12 周起步，下方磷绿punchline | 把"中国 SaaS 更需要 FDE"论点视觉化，强化国情对比 |

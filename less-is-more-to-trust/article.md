<!--
标题候选（发稿前跑 title-judge 再定；老雷拍板）：
1. 从「少即是多」到「值得信任」——AI 时代真正稀缺的东西
2. 乔布斯的「少即是多」，正在被 AI 悄悄改写
3. 三次稀缺的迁移：信息、注意力，和 AI 之后的那个东西
当前 H1 暂用候选 1。
-->
...
不是什么产品经理书单里的东西，是王阳明的《传习录》。读到一段讲「惟精惟一」的，他打了个米的比方：想让一碗米纯白干净，光在心里想「我要它纯」没有用，得真去舂、去簸、去筛、去拣，把糠秕一点点去掉，米自己就白了。

我盯着这段看了很久，然后把手机放下了。

因为我脑子里冒出来的，是乔布斯那句话——Less is more。一个做了十几年营销和产品的人，深夜读明代心学，读出来的居然是自己天天挂在嘴边的产品哲学。那一刻我意识到，我可能一直没真正搞懂这句话。
...
但我那天晚上真正被点醒的，是拉姆斯改的那个字。大家天天引用的是 "Less is more"，可原话是 "Less, but **better**"。**那个「但更好」，才是全部的重量。**
...
那天读完王阳明我才明白，减只是手上的动作，目的另有其物。舂米的人一遍遍舂、簸、筛，去掉的是糠，留下的是米——他心里始终盯着那碗「纯白的米」。**减法真正难的地方，从来不是舍得删，是判断该删掉哪一个。** 删对了是米，删错了是把米也筛没了。

市面上学乔布斯学到走火入魔的产品太多了，满屏留白、按钮藏得找都找不到，看着极简，用起来处处别扭。它们抄到了「少」，没抄到「但更好」。
...
所以判准从来没有「多好还是少好」这么简单。它落在一个更朴素的问题上：这个场景里，用户最缺的到底是什么？他缺选择、缺丰盛，那就多；他被淹没了、缺清静、缺一个能信的答案，那就少。乔布斯的天才，在于他早早看准了：在数字时代，最稀缺的那样东西，从「商品」翻成了「注意力」。
...
但真正让我坐直的，是另一件事——稀缺的东西，正在往下游搬家。

就像当年从「信息稀缺」搬到了「注意力稀缺」一样，现在正从「注意力稀缺」往「信任稀缺」「判断稀缺」搬。你想想，当任何内容都能被无限生成、被伪造，当 AI 能给你吐出一万个看着都对的答案，你还缺内容吗？你缺的是——这里面哪个能信，哪个是真的好，哪个值得你花时间。

我盯着 AI 生成的第一百段文案时，忽然懂了王阳明那碗米。

AI 把糠做成了无限。它能无穷无尽地生产「文」——漂亮的、通顺的、看着专业的表达。可它生产不出那碗纯白的「米」——那个「哪个才对、哪个才好」的判断。而这个判断，恰恰是拉姆斯那个「但更好」，是乔布斯说不清怎么来的品位，是王阳明讲了一辈子的、每个人心里那把叫良知的尺子。

**AI 越强，这把尺子越值钱。** 因为外面的东西——内容、选项、答案——全都烂大街了，剩下唯一还稀缺、还没法被批量生产的，就是「什么是好」的判断力本身。
...
第一条，从「抢注意力」到「配得上信任」。过去二十年，产品都在抢你的眼球——无限下滑、红点推送、多巴胺循环，把你的时间榨干。可当 AI 能无限生成看着都对的东西，抓眼球就不再是护城河了，你敢不敢信我，才是。来源可查、有人署名担责、品位始终如一——信任会变成新的壁垒。做营销的人最该嗅到这个：AI 文案泛滥之后，一个敢署自己名字、敢负责的品牌，比一百条漂亮空文值钱。
...
第三条，从「填满你的注意力」到「还你注意力」。上一代产品分成了两拨：一拨拼命榨取你的时间，刷到你麻木；一拨干完活就退场，把时间还给你。AI 时代能收溢价的，是后者——帮你做你真正想做的事，而不是做那件最能留住你的事。

减法这件事，到 AI 时代升级了。过去是删按钮、降认知负荷；现在是替你把噪音删掉、把泔水挡在外面、甚至把「你要费神做的那个判断」都替你做好。减法从「更少的按钮」，升到了「更少你要操的心」。
...
「少即是多」从来就是「少，但更好」。舂掉的是糠，留下的是米。乔布斯做了一辈子减法，减到最后剩下的，是一种没法教、说不清、只能自己一次次磨出来的品位。

现在 AI 把糠做成了无限，把那碗纯白的米，反而衬成了这个时代唯一还稀缺的东西——你的判断，你的品位，你值不值得被信任。

五百年前那个被贬到贵州龙场、在山洞里悟道的人，其实早把话说完了。他说，别往外面去堆，去追，去攒；那把最准的尺子，本来就在你心里，你要做的是把它擦亮。

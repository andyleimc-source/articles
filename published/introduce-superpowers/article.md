# 用了 Superpowers，我的 Claude Code 返工少了九成
...
![Superpowers 的 GitHub 主页，截至目前已有 137k stars](image/superpower-github.png)
...
![四个调研 agent 并行执行，分别研究四种方案，最后汇总对比分析](image/superpowers多线程执行.png)
